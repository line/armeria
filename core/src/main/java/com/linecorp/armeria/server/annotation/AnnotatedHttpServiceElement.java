...
public final class AnnotatedHttpServiceElement {
    ...
    /**
     * Returns the {@link PathMapping} which is a path param extractor with placeholders,
     * e.g., "/const1/{var1}/{var2}/const2"
     */
    ...
    /**
     * Returns the annotated HTTP service that will handle the request.
     */
    ...
    /**
     * Returns the decorator of the annotated HTTP service which will be evaluated at service registration time.
     */
