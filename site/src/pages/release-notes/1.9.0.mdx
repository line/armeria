...
- You can now get the last value of a header name or a query param using
  ...
  ```
- You can now see the specific information such as the length of transferred, delta, and limit
  from a <type://ContentTooLargeException>. #3520 #3616
...
- You can now figure out how many connections that a <type://ClientFactory> is managing
  using <type://ClientFactory#numConnections()>. #3596 #3613
- You can now specify the number of event loop threads and blocking task threads. #3597 #3602
  ```java
  Server.builder()
        .workerGroup(3)
