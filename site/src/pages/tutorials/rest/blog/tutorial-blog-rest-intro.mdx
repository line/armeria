...
1. [Creating a server](/tutorials/rest/blog/tutorial-blog-rest-create-server)
2. [Preparing a data object](/tutorials/rest/blog/tutorial-blog-rest-prepare-data-object)
3. [Adding services to server](/tutorials/rest/blog/tutorial-blog-rest-add-services-to-server)
4. [Implementing CREATE operation](/tutorials/rest/blog/tutorial-blog-rest-create)
5. [Implementing READ operation](/tutorials/rest/blog/tutorial-blog-rest-read)
6. [Implementing UPDATE operation](/tutorials/rest/blog/tutorial-blog-rest-update)
7. [Implementing DELETE operation](/tutorials/rest/blog/tutorial-blog-rest-delete)
