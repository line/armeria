...
- 클라우드 환경에서 서버의 위치를 파악하기 위해 Kubernetes 유형의 DNS(Domain Name System)와 ZooKeeper를 활용한 서비스 검색(discovery)을 제공([참고](/docs/server/service-registration#zookeeper-based-service-registration-with-zookeeperupdatinglistener))하고 있습니다.
