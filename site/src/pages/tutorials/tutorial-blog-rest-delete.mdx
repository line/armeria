...
To test deleting a blog post, you need to have blog posts created, which requires you to have the creation method implemented in the BlogService.java. See [Step 4. Implement CREATE](/tutorials/tutorial-blog-rest-create) for instructions.
...
2. Create a couple of blog posts to test deleting a blog post and get the ID value returned. Enter the cURL commands below.
  ...
  {"id":1,"title":"Second blog for test retrieving","content":"Create to read for the second time","createdAt":...,
  "modifiedAt":...}
  ```
