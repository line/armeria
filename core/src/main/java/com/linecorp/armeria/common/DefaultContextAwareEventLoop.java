...
final class DefaultContextAwareEventLoop
    ...
    public ScheduledFuture<?> scheduleAtFixedRate(
        ...
        return eventLoop.scheduleAtFixedRate(contextOrNull().makeContextAware(command), initialDelay, period, unit);
    }

    @Override
    public ScheduledFuture<?> scheduleWithFixedDelay(
            Runnable command, long initialDelay, long delay, TimeUnit unit) {
        return eventLoop.scheduleWithFixedDelay(contextOrNull().makeContextAware(command), initialDelay, delay, unit);
    }
