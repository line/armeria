...
Besides Armeria, the sample service uses [Guava](https://github.com/google/guava) and [Jackson](https://github.com/FasterXML/jackson). Let's add them in the build.gradle file.

```groovy filename=build.gradle highlight=9,10
apply plugin: 'java'
apply plugin: 'idea'
...
dependencies {
  ...
  implementation "com.google.guava:guava:${versions['com.google.guava:guava']}"\n
  implementation "com.fasterxml.jackson.core:jackson-core:${versions['com.fasterxml.jackson.core:jackson-core']}"\n
  // Logging
...
Using Armeria's [Documentation Service](/docs/server-docservice), you can see a server running, receiving requests and providing responses.
