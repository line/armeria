...
- `annotated-http-service-kotlin` <a href="https://gitpod.io/#project=annotated-http-service-kotlin/https://github.com/line/armeria-examples/tree/main/annotated-http-service-kotlin/src/main/kotlin/example/armeria/server/annotated/kotlin/Main.kt">
  ...
  - See [Kotlin coroutines support](https://line.github.io/armeria/docs/server-annotated-service#kotlin-coroutines-support).
...
- `thrift` <a href="https://gitpod.io/#project=grpc/https://github.com/line/armeria-examples/tree/main/thrift/src/main/java/example/armeria/thrift/Main.java">
  ...
  - See [Running a Thrift service](https://line.github.io/armeria/docs/server-thrift) and
    [Calling a Thrift service](https://line.github.io/armeria/docs/client-thrift).
...
- See [Configure `-parameters` javac option](https://line.github.io/armeria/docs/setup#configure--parameters-javac-option) to configure IntelliJ IDEA.
