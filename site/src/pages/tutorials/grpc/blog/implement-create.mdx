...
In the `BlogServiceTest` class, add a variable and a method as follows.
...
Next, at [Step 5. Implement READ](/tutorials/grpc/blog/implement-read), we'll implement a READ operation to read a single post and also multiple posts.
