...
A context-aware blocking executor is used as a dispatcher if you annotate a service method with <type://@Blocking> or enable the `useBlockingTaskExecutor` property.
