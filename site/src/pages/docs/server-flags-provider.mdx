...
Flags are global variables that controls the behavior of Armeria. You can can implement a <type://FlagsProvider> and let Armeria discover it for the following purposes:
