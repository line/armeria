...
1. Create a file, `BlogServiceTest.java`, and declare the test class.
  ...
  ```
2. Register a <type://ServerExtension> to set up a server instance for testing.
      ...
      static final ServerExtension server = new ServerExtension() {
          ...
          protected void configure(ServerBuilder sb) throws Exception {
              sb.service("/thrift", THttpService.builder()
                                                .addService(new BlogServiceImpl()) // Add the service to the configuration
                                                .build());
          }
      };
  }
...
4. Run the test case on your IDE or using Gradle.
  ...
  The service worked as expected if you see the test case is passed.
