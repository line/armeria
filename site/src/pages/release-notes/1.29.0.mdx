...
- You can now use an <type://AsyncLoader> to load a value atomically and asynchronously. #5506 #5590
  ```java
...
- You can now specify options for an <type://HttpService> via <type://ServiceOptions>. #5071 #5574
  ...
  class MyService {
      @ServiceOption(requestTimeoutMillis = 10000, maxRequestLength = 1024)
      @Get("/hello")
