...
To test deleting a blog post, you need to have blog posts created, which requires you to have the creation method implemented in the BlogService.java. See [Step 4. Implement CREATE](/tutorials/rest/blog/tutorial-blog-rest-create) for instructions.
  ...
  public class BadRequestExceptionHandler implements ExceptionHandlerFunction {
    ...
    public HttpResponse handleException(ServiceRequestContext ctx, HttpRequest req, Throwable cause) {
      if (cause instanceof IllegalArgumentException) {
        ㄴㅇ  String message = cause.getMessage();
