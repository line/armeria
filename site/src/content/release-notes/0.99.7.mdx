...
- It's now allowed to specify an absolute URL _only when_ a [WebClient](type) was created _without_ a base
  URL. #2757
  ```java
...
- You can specify an absolute URL _only when_ a [WebClient](type) was created _without_ a base URL.
