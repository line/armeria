...
authors:
  - seunghwanjoo
other_languages:
  en: /blog/2021/08/04/customizing-armeria-metrics
---
...
이전 글 [Armeria에서 Prometheus 지표 모니터링하기](/blog/ko/2021/06/28/monitoring-prometheus-metrics-from-armeria)에서 Armeria 지표를 Grafana로 모니터링하는 방법을 살펴봤습니다.
이번 글에는 Armeria에서 필요에 따라 지표를 커스터마이징하는 방법을 알아보겠습니다.

{/* truncate */}

> 이번 글에서 사용한 코드는 [Armeria에서 Prometheus 지표 모니터링하기](/blog/ko/2021/06/28/monitoring-prometheus-metrics-from-armeria) 글의 예제 코드를 재사용했습니다.
...
이때 [RequestLog#requestHeaders](<https://javadoc.io/doc/com.linecorp.armeria/armeria-javadoc/1.8.0/com/linecorp/armeria/common/logging/RequestOnlyLog.html#requestHeaders()>)를 통해 요청 HTTP 메서드 이름을 가져올 수 있습니다. [RequestLog](https://javadoc.io/doc/com.linecorp.armeria/armeria-javadoc/1.8.0/com/linecorp/armeria/common/logging/RequestLog.html)에는 이외에도 하나의 요청을 처리하면서 발생하는 다양한 정보들이 수집되는데요. 자세한 내용은 [Armeria 공식 블로그](/docs/advanced-structured-logging/)에서 확인하실 수 있습니다.
