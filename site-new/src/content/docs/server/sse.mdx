...
Armeria provides several factory methods by [ServerSentEvents](type) class which help a user to easily send
...
Of course, Armeria provides [@ProducesEventStream](type) annotation in order to convert the result objects
