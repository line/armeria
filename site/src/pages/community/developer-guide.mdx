...
- [OpenJDK 17-19](https://adoptium.net/)
...
- [`settings.jar`](https://github.com/line/armeria/raw/master/settings/intellij_idea/settings.jar) -
...
- [`formatter.xml`](https://github.com/line/armeria/raw/master/settings/eclipse/formatter.xml) -
...
- [`formatter.importorder`](https://github.com/line/armeria/raw/master/settings/eclipse/formatter.importorder) -
...
- [`cleanup.xml`](https://github.com/line/armeria/raw/master/settings/eclipse/cleanup.xml) -
...
- Configure [Java Save Actions Preferences](https://help.eclipse.org/neon/index.jsp?topic=%2Forg.eclipse.jdt.doc.user%2Freference%2Fpreferences%2Fjava%2Feditor%2Fref-preferences-save-actions.htm).
  <details><summary>Click here to see the screenshot.</summary>
    <img src="https://github.com/line/armeria/raw/master/settings/eclipse/save_actions.png" />
  </details>
