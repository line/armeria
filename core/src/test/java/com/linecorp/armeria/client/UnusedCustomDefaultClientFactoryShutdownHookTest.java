...
final class UnusedCustomDefaultClientFactoryShutdownHookTest {

    @Test
    void shutdownHookShouldNotInitializeUnusedCustomDefaultClientFactory()
        ...
        final Process process = new ProcessBuilder(
                ...
                "-cp",
                classpath,
                UnusedCustomDefaultClientFactoryShutdownHookTestApp.class.getName())
        ...
        assertThat(output).doesNotContain(TestDefaultClientFactory.CLOSED_MARKER);
    }
