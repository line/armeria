...
- `HttpRequest.aggregateWithPooledObjects()`, `HttpResponse.aggregateWithPooledObject` have been replaced with
  <type://PooledHttpRequest> and <type://PooledHttpResponse>. #2448
