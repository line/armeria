...
/**
 * A {@link Service} that decorates another {@link Service}. Use {@link SimpleDecoratingGraphQLExecutor}
 * if your {@link Service} has the same {@link Request} and {@link Response}
 ...
 */
public abstract class DecoratingGraphQLExecutor<T_I extends Request, T_O extends Response,
     ...
     */
    protected DecoratingGraphQLExecutor(Service<T_I, T_O> delegate) {
        super(delegate);
    }
}
