...
Create a service file, BlogService.java. You can see the full version of the file [here](https://github.com/line/armeria-examples/blob/master/tutorials/rest-api-annotated-service/src/main/java/example/armeria/server/blog/BlogService.java).
...
2. Create and return an HTTP response using Armeria's <type://HttpResponse> and include the information of the post created.
