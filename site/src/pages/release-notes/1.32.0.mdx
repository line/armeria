...
- **LoadBalancer**: You can now create a <type://LoadBalancer> using various load balancing strategies to
...
- The Thrift module names are correctly set by replacing a dot followed by a digit with an underscore. #6075 #6076
...
- <type://ServerConfig#gracefulShutdownQuietPeriod()> and <type://ServerConfig#gracefulShutdownTimeout()>
  ...
  - Use <type://ServerConfig.gracefulShutdown(GracefulShutdown)> instead.
