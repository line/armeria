...
public final class ThriftCallService implements RpcService {
    ...
    public static ThriftCallService of(Object implementation) {
        ...
        return new ThriftCallService(ImmutableMap.of("", ImmutableList.of(implementation)), false);
    }
    ...
    public static ThriftCallService of(Map<String, ? extends Iterable<?>> implementations,
        ...
        return new ThriftCallService(implementations, useBlockingTaskExecutor);
    }
    ...
    private void invoke(
        ...
        try {
            ...
            if (func.isAsync() && useBlockingTaskExecutor) {
