...
class RedirectClientWithEmptyEndpointTest {

    @Test
    void testSelectionTimeoutPropagated() {
        final WebClient client = WebClient.builder(SessionProtocol.HTTP, new DynamicEndpointGroup())
                                          .followRedirects()
                                          .build();
