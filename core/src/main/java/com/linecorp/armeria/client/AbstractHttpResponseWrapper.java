...
abstract class AbstractHttpResponseWrapper implements StreamWriter<HttpObject> {

    private static final Logger logger = LoggerFactory.getLogger(AbstractHttpResponseWrapper.class);
    ...
    AbstractHttpResponseWrapper(DecodedHttpResponse delegate, EventLoop eventLoop, ClientRequestContext ctx,
    ...
    abstract void close(@Nullable Throwable cause, boolean cancel);
