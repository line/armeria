...
public interface ExecutionProtocol {
    ...
    /**
     * Returns the default {@link SessionProtocol} to use when this protocol is not itself
     * a {@link SessionProtocol}. For example, an xDS execution protocol may return
     * {@link SessionProtocol#HTTP} since it ultimately delegates to HTTP-based transport.
     *
     * <p>This is used by {@link com.linecorp.armeria.common.Scheme#sessionProtocol()} as a fallback
     * when the {@link ExecutionProtocol} is not a {@link SessionProtocol}.
     */
    default SessionProtocol defaultSessionProtocol() {
