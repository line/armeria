...
public interface ServiceBindingBuilder0 {
     ...
     */
    ServiceBindingBuilder0 requestTimeout(Duration requestTimeout);
     ...
     */
    ServiceBindingBuilder0 requestTimeoutMillis(long requestTimeoutMillis);
     ...
     */
    ServiceBindingBuilder0 maxRequestLength(long maxRequestLength);
     ...
     */
    ServiceBindingBuilder0 verboseResponses(boolean verboseResponses);
     ...
     * is used.
     */
    ServiceBindingBuilder0 requestContentPreviewerFactory(ContentPreviewerFactory factory);
     ...
     * is used.
     */
    ServiceBindingBuilder0 responseContentPreviewerFactory(ContentPreviewerFactory factory);
     ...
     */
    ServiceBindingBuilder0 contentPreview(int length);
     ...
     */
    ServiceBindingBuilder0 contentPreview(int length, Charset defaultCharset);

    /**
     * Sets the {@link ContentPreviewerFactory} for an HTTP request/response of a {@link Service}.
     */
    ServiceBindingBuilder0 contentPreviewerFactory(ContentPreviewerFactory factory);
     ...
     */
    ServiceBindingBuilder0 accessLogFormat(String accessLogFormat);
     ...
     */
    ServiceBindingBuilder0 accessLogWriter(AccessLogWriter accessLogWriter,
