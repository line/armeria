...
Add service methods to our blog service. We have an extra method for retrieving blog posts; one is for retrieving a single post and another for multiple posts.
...
In this step, we've defined a proto file for our service and generated Java code. Next, we'll implement a minimal blog service and also a client to [test run](/tutorials/grpc/blog/run-service).
