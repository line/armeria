...
Reactive Streams를 웹 프로그래밍에서 활용하기 위해서는 HTTP 요청과 응답에 백 프레셔를 이용해야 합니다. 이를 통해 유입되는 트래픽의 양에 탄력적으로 반응해야 하는데요. [다음 포스팅](/blog/ko/2020/02/19/reactive-streams-armeria-2)에선 이와 관련해 Armeria에서 Reactive Streams를 어떻게 사용하고 있는지 자세히 알아보겠습니다. 많이 기대해주세요!
