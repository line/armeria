...
class Java9RequestContextAwareRpcResponse extends Java9RequestContextAwareCompletableFuture<Object>
        implements RpcResponse {

    private static final AtomicReferenceFieldUpdater<Java9RequestContextAwareRpcResponse, Throwable>
            causeUpdater = AtomicReferenceFieldUpdater.newUpdater(Java9RequestContextAwareRpcResponse.class,
     ...
     */
    Java9RequestContextAwareRpcResponse(RequestContext ctx) {
        super(ctx);
    }
