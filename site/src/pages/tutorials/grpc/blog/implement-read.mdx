...
Here, we've implemented service methods and client methods to retrieve blog posts. Plus, we added a decorator. See [Decorating a client](/docs/client-decorator/) for more information. Next, we'll implement a method for [updating a blog post](/tutorials/grpc/blog/implement-update) and add an exception handler.
