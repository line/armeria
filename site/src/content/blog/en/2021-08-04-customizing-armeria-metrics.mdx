...
authors:
  - seunghwanjoo
other_languages:
  ko: /blog/ko/2021/07/15/customizing-armeria-metrics
---

# Customizing Armeria metrics

In my last post, [Monitoring Prometheus metrics from Armeria](/blog/2021/07/09/monitoring-prometheus-metrics-from-armeria), we took a look at how you can monitor Armeria metrics using Grafana.
...
For more information about this, please refer to the [Official Armeria documentation](/docs/advanced-structured-logging/).
