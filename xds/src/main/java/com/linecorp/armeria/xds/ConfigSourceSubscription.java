 ...
 * Created by {@link SotwConfigSourceSubscriptionFactory#create} and managed by Armeria.
 *
 * <p>Implementations watch an external source (file, KV store, etc.) and call
 * {@link SotwSubscriptionCallbacks#onDiscoveryResponse} when new data arrives.
 * Armeria calls {@link #updateInterests} when watched resource names change
