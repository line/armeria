...
public abstract class AbstractAthenzAuthorizerBuilder<SELF extends AbstractAthenzAuthorizerBuilder<SELF>> {
     ...
     */
    public final SELF policyConfig(AthenzPolicyConfig policyConfig) {
     ...
     */
    public final SELF oauth2KeysRefreshInterval(Duration oauth2KeysRefreshInterval) {
     ...
     */
    public final SELF oauth2KeysPath(String oauth2KeysPath) {
     ...
     */
    public final SELF maxTokenCacheSize(int maxTokenCacheSize) {
