...
public class ThriftDocServiceTest {
    ...
    public static final ServerRule server = new ServerRule() {
        ...
        protected void configure(ServerBuilder sb) throws Exception {
            ...
            sb.serviceUnder("/excludeAll/", new DocServiceBuilder()
                    .excludeService(service -> HelloService.class.getName().equals(service) ||
                                               Cassandra.class.getName().equals(service) ||
                                               Hbase.class.getName().equals(service) ||
                                               OnewayHelloService.class.getName().equals(service) ||
                                               SleepService.class.getName().equals(service))
                    .excludeService(service -> FooService.class.getName().equals(service))
                    .build());
        }
    };
    ...
    public void testOk() throws Exception {
        ...
        final JsonNode expectedJson = mapper.valueToTree(
                ThriftDocServicePlugin.generate(entries,
                                                (service, method) -> true,
    ...
    public void excludeAllServices() throws IOException {
        ...
        System.err.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(actualJson));
