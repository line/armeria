...
/**
 * A {@link LogSanitizer} for HTTP request.
 */
final class RequestLogSanitizer implements LogSanitizer {
    ...
    public String sanitizeHeaders(RequestContext ctx, HttpHeaders headers) {
        final Object sanitized = headersSanitizer.apply(ctx, (RequestHeaders) headers);
