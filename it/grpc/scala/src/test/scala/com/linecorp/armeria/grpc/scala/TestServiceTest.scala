...
import com.linecorp.armeria.grpc.scala.TestServiceTest.{GrpcSerializationProvider, newClient}
...
import testing.grpc.hello.TestServiceGrpc.TestServiceStub
import testing.grpc.hello.{HelloRequest, TestServiceGrpc}
...
class TestServiceTest {
  ...
  def exceptionMapping(serializationFormat: SerializationFormat): Unit = {
    val helloService = newClient[TestServiceStub](serializationFormat)
