...
final class HttpServerFirstTransferLogger extends ChannelDuplexHandler {

    private final ServiceRequestContext reqCtx;

    private boolean loggedRequestHeadersFirstBytesTransferred;
    private boolean loggedResponseHeadersFirstBytesTransferred;

    HttpServerFirstTransferLogger(ServiceRequestContext reqCtx) {
        this.reqCtx = reqCtx;
    }
