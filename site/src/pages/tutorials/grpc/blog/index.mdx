...
Before we get our hands on the tutorial, let's switfly go over Armeria's gRPC features. Armeria supports you features that the upstream (gRPC-Java) does not support.
...
- [gRPC documentation service](https://armeria.dev/docs/server-docservice)
...
Using Armeria's [Documentation Service](/docs/server-docservice), you can check a server running, receiving requests and sending responses.
