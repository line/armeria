...
final class StaticResourceUtils {
    ...
    static RouteResourceNode staticRoute(BootstrapContext context, String resourceName,
    ...
    static VirtualHostResourceNode staticVirtualHost(
            BootstrapContext context, String resourceName,
    ...
    static EndpointResourceNode staticEndpoint(BootstrapContext context, String resourceName,
