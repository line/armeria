...
In the prior step, we tried to create a blog post. In this step, we'll implement a read operation and make a call to read blog posts. We'll write two service methods, one for reading a single post and another for multiple posts.
...
This time, we'll add a method each for retrieving posts.
...
1. Add a decorator to the client instance.
  ...
  class BlogClient {
    public static void main(String[] args) throws Exception {
      ...
      client = GrpcClients.builder("gproto+http://127.0.0.1:8080/")
