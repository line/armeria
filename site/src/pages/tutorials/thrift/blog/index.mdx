...
The [sample service code](https://github.com/line/armeria-examples/tree/main/tutorials/thrift) consists the following folders and files.
...
If you are trying the tutorial from scratch, base your file on the [sample service's](https://github.com/line/armeria-examples/blob/main/tutorials/thrift/build.gradle).
