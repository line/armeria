...
public final class UnauthorizedClientException extends TokenRequestException {
    ...
    /**
     * Constructs a new {@link UnauthorizedClientException} using {@code errorDescription} and {@code errorUri}.
     ...
     */
    public UnauthorizedClientException(String errorDescription, String errorUri) {
     ...
     */
    public UnauthorizedClientException(String errorDescription, String errorUri, Throwable cause) {
