...
import com.linecorp.armeria.context.rxjava2.RequestContextSingle.RequestContextSingleObserver;

import io.reactivex.Single;
import io.reactivex.SingleObserver;
import io.reactivex.SingleSource;

class RequestContextCallableSingle<T> extends Single<T> implements Callable<T> {
