...
final class HttpClientDelegate implements HttpClient {
    ...
    private void acquireConnectionAndExecute0(ClientRequestContext ctx, Endpoint endpoint,
        ...
        final ClientTlsSpec tlsSpec = determineTlsSpec(ctx, endpoint, protocol, tlsProvider);
    ...
    private ClientTlsSpec determineTlsSpec(
            ClientRequestContext ctx, Endpoint endpoint, SessionProtocol sessionProtocol,
            TlsProvider tlsProvider) {
        final ClientTlsSpec clientTlsSpec = ctx.clientTlsSpec();
