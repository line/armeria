...
The sample service([download](https://github.com/line/armeria-examples/tree/main/tutorials/grpc)) provides implementations of CRUD operations as specified below.
