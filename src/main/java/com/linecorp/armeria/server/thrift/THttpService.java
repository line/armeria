...
public class THttpService extends AbstractHttpService {
     ...
     * protocols and defaulting to {@link SerializationFormat#THRIFT_BINARY TBinary} protocol when the client
     * doesn't specify one.
     *
     ...
     * all thrift protocols and defaulting to {@link SerializationFormat#THRIFT_BINARY TBinary} protocol when
    ...
    public static THttpService of(Map<String, ?> implementations) {
        return of(implementations, SerializationFormat.THRIFT_BINARY);
    }
