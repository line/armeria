      ...
      case _ if isJsonSeq =>
        ...
        val response = result match {
          case publisher: Publisher[_] =>
            fromPublisherMH.invoke(null, headers, publisher.asInstanceOf[Publisher[Any]], trailers, jfunction)
          case stream: Stream[_] =>
            fromStreamMH.invoke(
              ...
              jfunction)
          case _ =>
            fromObjectMH.invoke(null, headers, result, trailers, jfunction)
        }
        response.asInstanceOf[HttpResponse]
...
private object ScalaPbResponseConverterFunction {
  ...
  private val fromPublisherMH: Method = {
  ...
  private val fromStreamMH: Method = {
    val method: Method = classOf[JsonTextSequences].getDeclaredMethod(
      "fromStream",
      classOf[ResponseHeaders],
      classOf[Stream[_]],
  ...
  private val fromObjectMH: Method = {
    val method: Method = classOf[JsonTextSequences].getDeclaredMethod(
      "fromObject",
      classOf[ResponseHeaders],
      classOf[Object],
