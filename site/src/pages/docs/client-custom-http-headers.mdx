...
- Using the <type://Clients#withHttpHeaders(Consumer)> method
- Using the <type://ClientOption#HTTP_HEADERS> option
...
you can use <type://Clients#withHttpHeader(CharSequence,String)> simply:
...
<type://ClientOption#HTTP_HEADERS> which is more efficient:
...
Note that this method is as efficient as the <type://ClientOption#HTTP_HEADERS> option.
Choose whichever you prefer.

## Using a derived client

Although not as simple as using <type://Clients#withHttpHeader(CharSequence,String)>,
