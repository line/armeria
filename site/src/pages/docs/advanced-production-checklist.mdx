...
- Consider increasing <type://ClientFactoryBuilder#maxNumEventLoopsPerEndpoint(int)>
  and <type://ClientFactoryBuilder#maxNumEventLoopsPerHttp1Endpoint(int)> when a
  ...
  of event loops up to the quantity in <type://ClientFactory#eventLoopGroup()>.
