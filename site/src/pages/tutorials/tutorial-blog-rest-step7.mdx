...
In [Step 1. Create a server](/tutorials/tutorial-blog-rest-step1), you've added a dummy service just to check that a server is launched. Now, let's remove the dummy service and add our blog service.
