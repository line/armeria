...
- The completion of <type://ClientRequestContext#whenResponseCancelling()> and <type://ClientRequestContext#whenResponseCancelled()>
  is now guaranteed even if <type://RequestContext#cancel()> is invoked before the initialization of 
