...
public final class UnexpectedDecodeException extends RuntimeException {
     ...
     */
    public UnexpectedDecodeException(String message) {
        super(message);
    }
     ...
     */
    public UnexpectedDecodeException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public UnexpectedDecodeException(Throwable cause) {
        super(cause);
    }
}
