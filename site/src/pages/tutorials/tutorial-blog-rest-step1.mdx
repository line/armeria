...
1. Create a main class and add import statements. You can see the full version of the file [here](https://github.com/line/armeria-examples/blob/master/tutorials/rest-api-annotated-service/src/main/java/example/armeria/server/blog/Main.java).
...
Next, at [Step 2. Prepare a data object](/tutorials/tutorial-blog-rest-step2), you'll write a data object to specify and contain blog post information.
