...
The sample service([download here](https://github.com/line/armeria-examples/tree/main/tutorials/thrift)) provides you implementations of CRUD operations as specified below.
