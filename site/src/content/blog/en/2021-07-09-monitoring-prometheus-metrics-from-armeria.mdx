...
authors:
  - seunghwanjoo
other_languages:
  ko: /blog/ko/2021/06/28/monitoring-prometheus-metrics-from-armeria
---

# Monitoring Prometheus metrics from Armeria

In this post, we'll be taking a look at how you can monitor [Prometheus](https://prometheus.io/) metrics collected with [Armeria](/).
