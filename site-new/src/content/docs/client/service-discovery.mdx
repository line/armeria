...
If you are using a service mesh with xDS (e.g., Istio or Envoy), see the [xDS section](/docs/advanced/xds/getting-started) for xDS-based service discovery and load balancing.
...
is called _dynamic endpoint group_.
...
You can decorate _any_ [EndpointGroup](type) implementations with [HealthCheckedEndpointGroup](type),
