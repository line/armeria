...
- You can now bind [GraphQL Java](https://www.graphql-java.com/) to <type://ServerBuilder> 
...
- You can now get the last value of a header name or a query param using
  ...
  ```
- You can now specify the current and max content length when creating <type://ContentTooLargeException>.
  #3520 #3616
