...
class RequestContextStorageProviderFlagTest {

    @Test
    void requestContextStorageProviderIsProvidedAndNoFQCNisSpecify() {
        ...
        assertThat(actual).isInstanceOf(CustomRequestContextStorage.class);
    }
}
