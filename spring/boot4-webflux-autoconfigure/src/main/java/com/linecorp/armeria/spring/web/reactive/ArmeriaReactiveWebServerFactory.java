...
/**
 * A web server factory which is used to create a new {@link ArmeriaWebServer}.
 */
public class ArmeriaReactiveWebServerFactory extends VersionSpecificReactiveWebServerFactory {
    ...
    private static com.linecorp.armeria.spring.Ssl toArmeriaSslConfiguration(Ssl ssl) {
        ...
        if (ssl.getKeyAlias() != null) {
            armeriaSsl.setKeyAlias(ssl.getKeyAlias());
        }
        if (ssl.getKeyPassword() != null) {
            armeriaSsl.setKeyPassword(ssl.getKeyPassword());
        }
        if (ssl.getKeyStore() != null) {
            armeriaSsl.setKeyStore(ssl.getKeyStore());
        }
        if (ssl.getKeyStorePassword() != null) {
            armeriaSsl.setKeyStorePassword(ssl.getKeyStorePassword());
        }
        if (ssl.getKeyStoreType() != null) {
            armeriaSsl.setKeyStoreType(ssl.getKeyStoreType());
        }
        if (ssl.getKeyStoreProvider() != null) {
            armeriaSsl.setKeyStoreProvider(ssl.getKeyStoreProvider());
        }
        if (ssl.getTrustStore() != null) {
            armeriaSsl.setTrustStore(ssl.getTrustStore());
        }
        if (ssl.getTrustStorePassword() != null) {
            armeriaSsl.setTrustStorePassword(ssl.getTrustStorePassword());
        }
        if (ssl.getTrustStoreType() != null) {
            armeriaSsl.setTrustStoreType(ssl.getTrustStoreType());
        }
        if (ssl.getTrustStoreProvider() != null) {
            armeriaSsl.setTrustStoreProvider(ssl.getTrustStoreProvider());
        }
        return armeriaSsl;
    }
