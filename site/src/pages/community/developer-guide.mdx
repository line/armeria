...
to take advantage of better build scan caching. By doing so, you may:

1. Visualize and troubleshoot build issues more easily.
2. Experience faster builds due to build caches.

Let us know at the [Armeria Discord](https://armeria.dev/s/discord) channel, and we'll create an access
token for you. Afterwards, you may integrate your local environment with the following command:
