...
Just check that you've prepared the [prerequisites](./tutorial-blog-rest-intro/#prerequisites).
...
Later on, when we build our blog service, we'll come back to this part of the code to [add an actual service](./tutorial-blog-rest-step7).
