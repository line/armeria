...
implemented in the BlogService.java. See [Step 4. Implement CREATE](/tutorials/rest/blog/tutorial-blog-rest-create) for 
instructions.
...
1. Run the server like we did in [Step 1. Create a server](/tutorials/rest/blog/tutorial-blog-rest-create-server) by running the 
...
Next, at [Step 6. Implement UPDATE](/tutorials/rest/blog/tutorial-blog-rest-update), we'll implement an UPDATE operation to modify existing blog posts.
