...
In this step, we go back to the [Step 1. Create a server](/tutorials/tutorial-blog-rest-step1) and add the blog service to the server. Also, we'll add Armeria's [DocService](/docs/server-docservice) to test our blog service.
...
Let's check our service running with Armeria's Documentation service.
