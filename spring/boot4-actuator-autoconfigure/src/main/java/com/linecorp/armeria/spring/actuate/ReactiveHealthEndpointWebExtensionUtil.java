...
final class ReactiveHealthEndpointWebExtensionUtil {
    ...
    static HttpResponse handleMaybeReactorResult(StatusMapperWrapper statusMapper,
    ...
    private static HttpResponse handlePublisher(StatusMapperWrapper statusMapper,
