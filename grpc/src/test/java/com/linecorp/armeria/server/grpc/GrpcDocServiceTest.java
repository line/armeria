...
public class GrpcDocServiceTest {
        ...
        protected void configure(ServerBuilder sb) throws Exception {
            ...
            sb.serviceUnder(
                    ...
                    new DocServiceBuilder()
                            ...
                            .exclude(DocServiceFilter.methodName(TestServiceGrpc.SERVICE_NAME, "EmptyCall"))
                            .build()
                            .decorate(LoggingService.newDecorator()));
            sb.serviceUnder("/excludeAll/", new DocServiceBuilder()
                    .exclude(DocServiceFilter.grpcOnly())
                    .build());
    ...
    public void testOk() throws Exception {
        ...
        final JsonNode expectedJson = mapper.valueToTree(new GrpcDocServicePlugin().generate(
                entries, unifyFilter(DocServiceFilter.allServices(),
                                     DocServiceFilter.methodName(TestServiceGrpc.SERVICE_NAME, "EmptyCall"))));
