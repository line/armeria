...
const Home: React.FC = (): ReactNode => {
  ...
  return (
    <>
      <Head>
        <meta name="algolia-site-verification" content="90A5F01485F88CCB" />
      </Head>
      <Layout
        description={
        ...
        <main>
          <Marketing>
            <MarketingBlock>
              ...
              <p>
                Armeria is capable of running services using different
                protocols, all on a single port. No need for any proxies or
                sidecars. Enjoy the reduced complexity and points of failure,
                even when migrating between protocols!
              </p>
            </MarketingBlock>
            <MarketingBlock>
      ...
      .start();
          ...
          <Marketing reverse>
            <MarketingBlock>
              ...
              <p>
                RPC protocols were often more difficult to work with than
                RESTful APIs. How would you make an ad-hoc call to your gRPC
                service when you can&apos;t find the right <code>.proto</code>{' '}
                file? How would you help your colleague reproduce your problem
                by making the same call?
              </p>
              <p>
                Armeria&apos;s <em>documentation service</em> allows you to
                browse the complete list of services and their documentation
                from a web browser. You can also make a real RPC call in human
                friendly JSON format and share the URL of the call with your
                colleague. Who said RPC is difficult to work with?{' '}
                <Emoji text="😆" />
              </p>
            </MarketingBlock>
            <MarketingBlock>
          ...
          <Marketing className={styles.testimonial}>
            <MarketingBlock>
              ...
              >
                ...
                our search system into separate services. Decorators make
                reusing existing components and building new ones a breeze. This
                helped streamline the integration of our new services with our
                existing infrastructure, including logging, monitoring, tracing,
                service discovery, and RPC. The modern Java API is a joy to use
                and the asynchronous architecture delivers great performance
                with high concurrency. The Armeria community has been very
                welcoming and the maintainers were very responsive to our needs
                during our migration process and beyond. We are now running
                several search and discovery services built on Armeria and it
                has become our framework of choice for building new Java
                services.
              </Blockquote>
            </MarketingBlock>
          </Marketing>
          <Marketing>
            <MarketingBlock>
              ...
              <p>
                There are so many cross-cutting concerns you need to address
                when building a microservice &mdash; metrics, distributed
                tracing, load balancing, authentication, rate-limiting, circuit
                breakers, automatic retries, etc.
              </p>
              <p>
                Armeria solves your problems by providing various reusable
                components called &lsquo;decorators&rsquo; in a clean,
                consistent, flexible and user-friendly API. You can also write a
                custom decorator if ours doesn&apos;t work for your use case.
              </p>
            </MarketingBlock>
            <MarketingBlock>
              <CodeBlock language="java">
          ...
          <Marketing reverse>
            <MarketingBlock>
              ...
              <p>
                ...
                It serves gRPC or Thrift requests at high efficiency while
                leaving other requests to Spring MVC, WebFlux or Dropwizard with
                minimal changes.
              </p>
              <p>
                Got a legacy webapp you need to keep running until you migrate
                off? No problem! Armeria can serve any legacy webapps that run
                on top of Tomcat or Jetty until you finish your migration.
                Adios, maintenance hell! <Emoji text="🥂" />
              </p>
            </MarketingBlock>
            <MarketingBlock>
              <object
          ...
          <Marketing className={styles.testimonial}>
            <MarketingBlock>
              <Blockquote
                ...
                reverse
              >
                Armeria has eased our adoption of gRPC at Afterpay. Serving
                gRPC, documentation, health checks and metrics on a single port
                (with or without TLS) gives us the functionality of a sidecar
                like Envoy in a single process. Automated serving of API
                documentation, complete with sample payloads, allows simple
                ad-hoc gRPC requests straight from the browser. Distributed
                tracing is trivial to configure using the built-in Brave
                decorators. Logging request bodies, performing retries or
                circuit breaking are all built-in. The friendly devs rapidly
                respond to issues and feature requests. Armeria is becoming the
                default stack for gRPC at Afterpay.
              </Blockquote>
            </MarketingBlock>
          </Marketing>
          <Marketing>
            <MarketingBlock>
              <Heading as="h1">
                Flexible <Highlight>service discovery</Highlight> and
                client-side <Highlight>load-balancing</Highlight>
              </Heading>
              <p>
