...
1. Create the `Main` class for the server.
  You can see the full version of the file [here](https://github.com/line/armeria-examples/tree/main/tutorials/grpc/src/main/java/example/armeria/server/blog/grpc/Main.java).
