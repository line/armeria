...
@DirtiesContext
class SpringDependencyInjectorBeanTest {
    ...
    public static class TestConfiguration {
        ...
        @Bean
        public DependencyInjector dependencyInjector(BeanFactory beanFactory) {
            return SpringDependencyInjector.of(beanFactory);
        }
