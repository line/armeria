...
public class WebSocketCloseException extends Exception {
    ...
    public WebSocketCloseException(int code) {
        super("Close status #" + code);
        webSocketCloseStatus = WebSocketCloseStatus.valueOf(code);
    }

    public WebSocketCloseException(WebSocketCloseStatus webSocketCloseStatus) {
        super(webSocketCloseStatus.reasonPhrase());
