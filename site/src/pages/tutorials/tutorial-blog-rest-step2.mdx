...
You need to create a blog post instance for creating and updating blog posts. First, let's add constructors for creating a blog post in the `BlogPost` class.
