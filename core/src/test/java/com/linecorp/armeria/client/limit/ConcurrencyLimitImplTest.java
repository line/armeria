...
import com.linecorp.armeria.client.limit.ConcurrencyLimitImplTest.ConcurrencyLimitParameterResolver;
import com.linecorp.armeria.common.HttpMethod;
import com.linecorp.armeria.common.HttpRequest;
import com.linecorp.armeria.testing.junit5.common.EventLoopExtension;

@ExtendWith(ConcurrencyLimitParameterResolver.class)
public class ConcurrencyLimitImplTest {
    @RegisterExtension
    ...
    @Test
    void itShouldExecuteImmediatelyWhilePermitsAreAvailable(ConcurrencyLimitImpl semaphore) {
    ...
    @Test
    void itShouldExecuteDeferredComputationsWhenPermitsAreReleased(ConcurrencyLimitImpl sem) {
    ...
    private static class CountingSemaphore {
        private final ConcurrencyLimitImpl sem;
        private final AtomicInteger count = new AtomicInteger(0);
        private final ConcurrentLinkedQueue<Permit> permits = new ConcurrentLinkedQueue<>();

        private CountingSemaphore(ConcurrencyLimitImpl sem) {this.sem = sem;}
    ...
    static class ConcurrencyLimitParameterResolver implements ParameterResolver {
        ...
        public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext)
            ...
            return parameterContext.getParameter().getType() == ConcurrencyLimitImpl.class;
        }

        @Override
        public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext)
                throws ParameterResolutionException {
            return new ConcurrencyLimitImpl(100000, 2, 100);
        }
    }
