...
public interface CircuitBreakerListener {
    ...
    /**
     * Returns a new {@link CircuitBreakerListener} that collects metric with the specified
     * {@link MeterRegistry}, {@link Meter} name and {@link Tags}.
     * The returned listener will generate the following metrics:
     * <table>
     * <caption>metrics that will be generated by this class</caption>
     * <tr>
     *   <th>metric name (if {@link Tags} was ["service","&lt;service name&gt;"])</th>
     *   <th>description</th>
     * </tr>
     * <tr>
     *   <td>{@code <name>.requests{service="<service name>",result="success"}}</td>
     *   <td>The number of successful requests in the counter time window.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.requests{service="<service name>",result="failure"}}</td>
     *   <td>The number of failed requests in the counter time window.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.transitions{service="<service name>",state="CLOSED"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#CLOSED}.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.transitions{service="<service name>",state="OPEN"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#OPEN}.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.transitions{service="<service name>",state="HALF_OPEN"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#HALF_OPEN}.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.transitions{service="<service name>",state="FORCED_OPEN"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#FORCED_OPEN}.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.rejected.requests{service="<service name>"}}</td>
     *   <td>The number of requests rejected by the circuit breaker.</td>
     * </tr>
     * </table>
     */
     ...
     * </tr>
     * <tr>
     *   <td>{@code <name>.requests{name="<circuit breaker name>",service="<service name>",
     *   result="success"}}</td>
     *   <td>The number of successful requests in the counter time window.</td>
     * </tr>
     * <tr>
     ...
     * </tr>
     * <tr>
     *   <td>{@code <name>.transitions{name="<circuit breaker name>",service="<service name>",
     *   state="CLOSED"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#CLOSED}.</td>
     * </tr>
     * <tr>
     ...
     * <tr>
     *   <td>{@code <name>.transitions{name="<circuit breaker name>",service="<service name>",
     *   state="FORCED_OPEN"}}</td>
     *   <td>The number of circuit breaker state transitions to {@link CircuitState#FORCED_OPEN}.</td>
     * </tr>
     * <tr>
     *   <td>{@code <name>.rejected.requests{name="<circuit breaker name>",service="<service name>"}}</td>
     *   <td>The number of requests rejected by the circuit breaker.</td>
     * </tr>
     * </table>
     */
    static CircuitBreakerListener metricCollectingWithNameAndTags(MeterRegistry registry, String name,
                                                                  Tags tags) {
        return new MetricCollectingCircuitBreakerListener(
                registry, name,
                new MetricCollectingCircuitBreakerListener.MetricTagBuilder.NameWithCustomTags(tags));
    }
