...
## 4. Prepare the thrift file for client
...
1. Create a thrift file, `blog.thrift`, as we did in [Define a service](/tutorials/thrift/blog/create-service#define-a-service) for the server.
2. Compile the `blog.thrift` file, as we did in [Compile the thrift file](/tutorials/thrift/blog/create-service#compile-the-thrift-file) for the server.
