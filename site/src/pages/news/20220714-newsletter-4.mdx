...
- ✨ We've released 7 new versions since our last newsletter with a bunch of new exciting features!
...
- 🦾 MSA(Microservices Architecture): Harder, Better, Faster, Stronger
  ...
  - Here is the [Video](https://youtu.be/1TsGYR1dves) and [Slide](https://speakerdeck.com/line_devday2021/msa-microservices-architecture-harder-better-faster-stronger) (also providing [Korean](https://youtu.be/95L-_82N1vg) and [Japanese](https://youtu.be/pXIdcgchvSU))
