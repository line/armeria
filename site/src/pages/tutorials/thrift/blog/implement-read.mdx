...
First, add an exception handler for the exception to be thrown when there is no blog post for the given ID.

1. Add an exception handler class for the blog service.
...
1. Add a service method in the `BlogServiceImpl` class to retrieve a single post.
  ...
  ```
2. Throw an exception in case there is no blog post for the given ID.
  ```java filename=BlogServiceImpl.java
  import example.armeria.blog.thrift.BlogNotFoundException;
...
1. Add a service method in the `BlogServiceImpl` class to retrieve multiple posts.
  ```java filename=BlogServiceImpl.java
  ...
  ```
2. Sort the blog posts based on the value of the `descending` parameter.
  ```java filename=BlogServiceImpl.java
...
Add a method in the `BlogClient` class to retrieve a single post.
...
Add a method in the `BlogClient` class to retrieve a list of posts.
