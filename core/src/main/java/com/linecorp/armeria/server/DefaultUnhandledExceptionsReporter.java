...
final class DefaultUnhandledExceptionsReporter implements UnhandledExceptionsReporter {
    ...
    private void reportException() {
        ...
        if (exception != null) {
            logger.warn("Observed {} exceptions that didn't reach a LoggingService in the last {}. " +
                        "Please consider either adding a LoggingService or moving the " +
                        "LoggingService to an earlier timing to get detailed error logs. " +
