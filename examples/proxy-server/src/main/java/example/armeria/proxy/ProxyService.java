...
public final class ProxyService extends AbstractHttpService {
    ...
    private final AsyncHttpClient loadBalancingClient;
    ...
    private static AsyncHttpClient newLoadBalancingClient() throws InterruptedException {
        ...
        return AsyncHttpClient.builder("http://group:animation_apis")
