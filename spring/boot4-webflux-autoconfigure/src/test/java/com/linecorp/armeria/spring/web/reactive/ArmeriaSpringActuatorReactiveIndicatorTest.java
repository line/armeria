...
import com.linecorp.armeria.spring.web.version.reactive.VersionSpecificTestUtil.TestReactiveHealthIndicator;
...
class ArmeriaSpringActuatorReactiveIndicatorTest {
    ...
    static class TestConfiguration {
        ...
        @Bean
        TestReactiveHealthIndicator testReactiveHealthIndicator() {
            return new TestReactiveHealthIndicator(healthy);
        }
    }
