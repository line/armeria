...
The sample service([download](https://github.com/line/armeria-examples/tree/main/tutorials/rest-api-annotated-service)) provides you implementations of CRUD operations as specified below.
