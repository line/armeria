...
public final class Resilience4jCircuitBreakerMappingBuilder extends AbstractCircuitBreakerMappingBuilder {
    ...
    private BiFunction<CircuitBreakerRegistry, String, CircuitBreaker> factory =
     ...
     * set {@link CircuitBreakerRegistry} and the mapping key generated by this
     * {@link Resilience4jCircuitBreakerMapping}.
     * By default, {@link CircuitBreakerRegistry#circuitBreaker(String)} is used as the
     * default factory method.
     * This method can be specified if one would like to customize the generated
     * {@link CircuitBreaker}.
     *
     * <pre>{@code
     * Resilience4jCircuitBreakerMapping
     *         .builder()
     *         .factory((registry, key) -> registry.circuitBreaker(key, "configA")) // specify a base config
     *         .build();
     * }</pre>
     */
