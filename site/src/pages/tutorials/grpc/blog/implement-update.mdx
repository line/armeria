...
1. In the BlogService.java file we've been working on, add a service method for updating a blog post. Leave the exception throwing part empty for now.
...
3. Add an exception handler class for the blog service.
  ...
  ```
4. Bind the exception handler `GrpcExceptionHandler` to our service.
