...
public class ArmeriaSpringActuatorAutoConfiguration {
    ...
    ArmeriaServerConfigurator actuatorServerConfigurator(
        ...
        return sb -> {
            ...
            if (managementServerPort != null && INTERNAL_SERVICES_CLASS == null) {
                configurePorts(sb, ImmutableList.of(managementServerPort));
            }
    ...
    @Nullable
    static Port obtainManagementServerPort(BeanFactory beanFactory,
        ...
        if (internalServices == null) {
            ...
            return maybeNewPort(properties.getPort(), properties.getAddress(),
    ...
    @Nullable
    static Integer getExposedInternalServicePort(BeanFactory beanFactory,
                                                 ArmeriaSettings armeriaSettings) {
        if (INTERNAL_SERVICES_CLASS == null) {
            return null;
        }
    ...
    @Nullable
    static CorsServiceBuilder corsServiceBuilder(CorsEndpointProperties corsProperties) {
    ...
    static void addOperationService(ServerBuilder sb, List<Integer> exposedPorts,
                                    WebOperation operation, StatusMapperWrapper statusMapper,
