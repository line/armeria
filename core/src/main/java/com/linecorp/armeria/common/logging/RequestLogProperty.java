...
public enum RequestLogProperty {
    ...
    static final int FLAGS_REQUEST_COMPLETE_WITHOUT_CONTENT_PREVIEW;
    static final int FLAGS_REQUEST_COMPLETE_WITHOUT_CONTENT_AND_CONTENT_PREVIEW;
    static final int FLAGS_RESPONSE_COMPLETE;
    static final int FLAGS_RESPONSE_COMPLETE_WITHOUT_CONTENT;
    static final int FLAGS_RESPONSE_COMPLETE_WITHOUT_CONTENT_PREVIEW;
    static final int FLAGS_RESPONSE_COMPLETE_WITHOUT_CONTENT_AND_CONTENT_PREVIEW;
    ...
    static {
        ...
        FLAGS_REQUEST_COMPLETE_WITHOUT_CONTENT_PREVIEW = FLAGS_REQUEST_COMPLETE & ~REQUEST_CONTENT_PREVIEW.flag;
        FLAGS_REQUEST_COMPLETE_WITHOUT_CONTENT_AND_CONTENT_PREVIEW =
                FLAGS_REQUEST_COMPLETE & ~(REQUEST_CONTENT.flag | REQUEST_CONTENT_PREVIEW.flag);
        ...
        FLAGS_RESPONSE_COMPLETE_WITHOUT_CONTENT_PREVIEW =
                FLAGS_RESPONSE_COMPLETE & ~RESPONSE_CONTENT_PREVIEW.flag;
        FLAGS_RESPONSE_COMPLETE_WITHOUT_CONTENT_AND_CONTENT_PREVIEW =
                FLAGS_RESPONSE_COMPLETE & ~(RESPONSE_CONTENT.flag | RESPONSE_CONTENT_PREVIEW.flag);
