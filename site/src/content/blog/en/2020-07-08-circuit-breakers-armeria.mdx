...
authors:
  - seunghwanjoo
other_languages:
  ko: /blog/ko/2020/04/27/circuit-breakers-armeria
---
...
And we can apply `CircuitBreaker` to the `WebClient` object using the [Decorator](/docs/client-decorator) provided by Armeria.
