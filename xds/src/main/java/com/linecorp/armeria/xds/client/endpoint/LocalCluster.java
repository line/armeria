...
final class LocalCluster {
    ...
    private final DefaultXdsLoadBalancer localLoadBalancer;
    ...
    LocalCluster(Locality locality, XdsLoadBalancer localLoadBalancer) {
        ...
        assert localLoadBalancer instanceof DefaultXdsLoadBalancer;
        this.localLoadBalancer = (DefaultXdsLoadBalancer) localLoadBalancer;
    }

    DefaultXdsLoadBalancer localLoadBalancer() {
