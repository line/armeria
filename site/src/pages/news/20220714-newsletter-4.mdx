...
- ✨ We've released several new versions since our last newsletter with a bunch of new exciting features!
  - [1.17.0](https://line.github.io/armeria/release-notes/1.17.0/)
  ...
  - [1.16.0](https://line.github.io/armeria/release-notes/1.16.0/)
  ...
  - [1.15.0](https://line.github.io/armeria/release-notes/1.15.0/)
  ...
  - [1.14.0](https://line.github.io/armeria/release-notes/1.14.0/)
...
- 👂 Armeria team is hosting [bi-weekly virtual office hours](https://line.github.io/armeria/community/office-hours/).
...
- 🎓 Try out this guided [tutorial](https://line.github.io/armeria/tutorials/rest/blog) for REST Service! This super friendly and simple tutorial will guide you to make a blog service, with which you can create, read, update and delete blog posts. In particular, you'll be using these Armeria features:
  - Service annotations
  - Request converter
  - Parameter injection
  - Exception handler
