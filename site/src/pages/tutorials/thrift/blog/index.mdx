...
The sample service([download](https://github.com/line/armeria-examples/tree/main/tutorials/thrift)) provides you implementations of CRUD operations as specified below.
