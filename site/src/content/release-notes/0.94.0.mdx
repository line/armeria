...
- You can now decorate multiple services by path mapping. See the [documentation](/docs/server-decorator#decorating-multiple-services-by-path-mapping) for more information. #582 #2040 #2057
