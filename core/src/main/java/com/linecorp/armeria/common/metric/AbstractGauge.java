...
/**
 * A skeletal {@link Gauge} implementation.
 */
public abstract class AbstractGauge extends AbstractMetric implements Gauge {

    /**
     * Creates a new instance with the specified {@link MetricKey}, {@link MetricUnit} and description.
     */
    protected AbstractGauge(MetricKey key, MetricUnit unit, String description) {
