...
public final class XdsResourceReader {
    ...
    private static <T extends GeneratedMessageV3> T from(URL url, Class<T> clazz) {
    ...
    private static <T extends GeneratedMessageV3> T parse(String content, Class<T> clazz, Parser parser) {
