...
import com.linecorp.armeria.context.rxjava2.RequestContextMaybe.RequestContextMaybeObserver;

import io.reactivex.Maybe;
import io.reactivex.MaybeObserver;
import io.reactivex.MaybeSource;

class RequestContextCallableMaybe<T> extends Maybe<T> implements Callable<T> {
