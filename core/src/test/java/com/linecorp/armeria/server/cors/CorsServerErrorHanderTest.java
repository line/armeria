...
public class CorsServerErrorHanderTest {
    ...
    static final ServerExtension server = new ServerExtension() {
        ...
        protected void configure(ServerBuilder sb) throws Exception {
            ...
            sb.service("/cors_status_exception", myService.decorate(
                    CorsService.builder("http://example.com")
                            ...
                            .newDecorator())
                    .decorate(new DecoratingHttpServiceFunction() {
                @Override
    ...
    @Test
    void testCorsHeaderWhenHttpStatusException() {
        final WebClient client = client();
        final AggregatedHttpResponse response = preflightRequest(client, "/cors_status_exception", "http://example.com",
                "GET");
