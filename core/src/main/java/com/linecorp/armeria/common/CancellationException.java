...
public class CancellationException extends RuntimeException {
    ...
    private static final long serialVersionUID = -5385580475651756095L;
     ...
     */
    public CancellationException(@Nullable String message, @Nullable Throwable cause) {
        super(message, cause);
    }
     ...
     */
    protected CancellationException(@Nullable String message, @Nullable Throwable cause,
