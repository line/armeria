...
public interface ConnectionPoolListener extends Unwrappable {
    ...
    /**
     * Returns a new {@link ConnectionPoolListener} that collects metrics with the specified
     ...
     * </table>
     */
    static ConnectionPoolListener metricCollecting(MeterRegistry registry, String name) {
        return new MetricCollectingConnectionPoolListener(registry, name);
    }
