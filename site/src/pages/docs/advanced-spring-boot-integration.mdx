...
It has rich support for [Apache Thrift](https://thrift.apache.org/) and [gRPC](https://grpc.io/).
It also includes a user-friendly [web console](https://armeria.dev/docs/server-docservice)
...
enabling non-blocking I/O operations. As a result, it demonstrates better performance in certain scenarios such as streaming media or
large files. By integrating your Spring application with Armeria, you can serve both legacy Spring services
