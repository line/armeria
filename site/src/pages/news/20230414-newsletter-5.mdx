...
- 📢 **Discontinuance of the virtual office hour**:
...
- 🙌 **[Armeria adopters page](https://github.com/line/armeria/discussions/4626) and limited goods package**:
  - You can now show off how well your service take adventage of Armeria!
  - Don't forget to request the limited goods packages.
<img src="../../images/limited_package.jpg" />
- 🚛 **Moving to Discord**:
  - We dicided to move to Discord to preserve all the past messages.
  - But no rush! We'll run the both Slack and Discord for a while. Please join [our Discord server](https://discord.gg/7FH8c6npmg) whenever you're ready.
- 🌟 **We're now 4K family members!**
  - It's amazing to see the steady growth of stars. Thank y'all.
<img src="../../images/4k-stars.png" width="214" />
...
- ✨ We've released several new versions since our last newsletter with a bunch of new exciting features! Here are the highlights between [1.17.1](https://armeria.dev/release-notes/1.17.1) and [1.23.1](https://armeria.dev/release-notes/1.23.1).
...
<img src="../../images/autocomplete-docservice.gif" />
...
- 🎓 Try out this [guided tutorial for gRPC Service](https://armeria.dev/tutorials/grpc/blog)! This super friendly and simple tutorial will guide you to make a blog service just like [the previous tutorial for REST services](https://armeria.dev/tutorials/rest/blog). But this time, you'll try step by step guide including:
...
- 🤔 Your opinion means a lot to us. Please let us know what you think about these proposals:
  - #4314 Provide an easier way to get a ClientRequestContext
  - #4569 Consider RFC 7807 Problem Details for HTTP APIs as the default response format in REST APIs
  - #4738 Consider a way to make OAuth2AuthorizaitonGrant dynamic when update the grant information needed
