...
import com.linecorp.armeria.xds.internal.XdsBootstrapRegistry.CachedPreprocessors;
...
final class XdsExecutionProtocol implements ExecutionProtocol {
    ...
    public URI validateUri(URI uri) {
        ...
        if (authority == null || authority.isEmpty()) {
            try {
                return new URI(uri.getScheme(), XdsBootstrapRegistry.defaultName(),
    ...
    public ClientBuilderParams translate(ClientBuilderParams params) {
        ...
        final CachedPreprocessors preprocessors =
                XdsBootstrapRegistry.preprocessors(bootstrapName, listenerName);
