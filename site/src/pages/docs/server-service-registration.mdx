...
Then, use <type://ConsulUpdatingListener> to register your server to the Consul:
...
[tags](https://www.consul.io/api-docs/agent/service#tags) to the <type://Server>, 
use <type://ConsulUpdatingListenerBuilder>:
