...
<type://ServerBuilder#multipartUploadsLocation(Path)> and the files are removed depending on the 
<type://MultipartRemovalStrategy>. If <type://MultipartRemovalStrategy#NEVER> is set, you should explicitly 
