        ...
        protected void configure(ServerBuilder sb) throws Exception {
            ...
            sb.serviceUnder(
                    ...
                    new DocServiceBuilder()
                            ...
                            .excludeMethod(
                                    (service, method) -> "armeria.grpc.testing.TestService".equals(service) &&
                                                         "EmptyCall".equals(method))
                            .build()
                            .decorate(LoggingService.newDecorator()));
            sb.serviceUnder("/excludeAll/", new DocServiceBuilder()
                    .excludeService(service -> "armeria.grpc.testing.ReconnectService".equals(service) ||
                                               "armeria.grpc.testing.TestService".equals(service))
                    .build());
