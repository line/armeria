...
public final class NoopClientRequestLifecycleListener implements ClientRequestLifecycleListener {
    ...
    /**
     * Returns NoopClientRequestLifecycleListener.
     * @return Returns NoopClientRequestLifecycleListener.
     */
    public static NoopClientRequestLifecycleListener getInstance() {
        return INSTANCE;
    }

    private NoopClientRequestLifecycleListener() { }
