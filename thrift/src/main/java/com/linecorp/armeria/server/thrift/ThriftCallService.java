...
public final class ThriftCallService implements RpcService {
    ...
    public static ThriftCallService of(Map<String, ?> implementations) {
        ...
        final ImmutableMap<String, ? extends ImmutableList<?>> implementationMap =
                implementations.entrySet().stream()
                               .map(e -> Maps.immutableEntry(e.getKey(), ImmutableList.of(e.getValue())))
                               .collect(toImmutableMap(Entry::getKey, Entry::getValue));
        return new ThriftCallService(implementationMap);
    }
     ...
     *                        the Apache Thrift compiler
     */
    public static ThriftCallService ofMultiple(Map<String, ? extends Iterable<?>> implementations) {
