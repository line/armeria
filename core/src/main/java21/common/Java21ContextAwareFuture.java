...
final class Java21ContextAwareFuture<T> extends AbstractContextAwareFuture<T> {

    Java21ContextAwareFuture(RequestContext requestContext) {
    ...
    public <U> CompletableFuture<U> newIncompleteFuture() {
        return new Java21ContextAwareFuture<>(context());
    }

    @Override
    public CompletionStage<T> minimalCompletionStage() {
        return new Java21ContextAwareMinimalStage<>(this);
    }
