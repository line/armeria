...
- OpenJDK 25 or its derivative, such as [Azul JDK](https://www.azul.com/downloads/?version=java-25&package=jdk#zulu)
...
[contact us](mailto:dl_armeria@linecorp.com) if you need the CCLA (corporate contributor license agreement).
...
IntelliJ IDEA is our primary IDE for developing Armeria.
...
<Tabs groupId="ide-settings" >
<TabItem label="IntelliJ IDEA" value="idea">
...
<TabItem label="Eclipse" value="eclipse">
...
to put all _notable_ changes in detail. It doesn't have to contain every single tiny
...
Again, you do not have to include all the modifications you made but _notable_ changes that you wish the
readers know.
...
our [release notes](/release-notes), e.g.
