...
In this step, we'll define service methods, objects, and an exception for server and client each.
...
In this step, we've defined service methods to implement one by one in later steps in this tutorial.
