...
final class Http1RequestDecoder extends ChannelDuplexHandler {
    ...
    private final Writability writability = new Writability();
    ...
    Http1RequestDecoder(AsciiString scheme) {
        this.scheme = scheme;
    }
        ...
        try {
            ...
            if (req != null && msg instanceof HttpContent) {
                ...
                if (dataLength != 0) {
                    ...
                    ArmeriaHttpUtil.publishInboundTraffic(ctx, req, data, writability);
                }
                ...
                if (msg instanceof LastHttpContent) {
                    ...
                    final DecodedHttpRequest req = this.req;
                    this.req = null;
                    req.close();
                }
            }
