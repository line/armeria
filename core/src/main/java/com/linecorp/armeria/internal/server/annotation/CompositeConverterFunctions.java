...
final class CompositeConverterFunctions {
    /**
     * A {@link ResponseConverterFunction} which wraps a list of {@link ResponseConverterFunction}s.
     */
    static final class CompositeResponseConverterFunction implements ResponseConverterFunction {
     ...
     */
    static final class CompositeRequestConverterFunction implements RequestConverterFunction {
