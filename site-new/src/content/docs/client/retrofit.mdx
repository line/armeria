...
Armeria provides a builder class called [ArmeriaRetrofit](type) that builds an alternative
...
Now, you can build `Retrofit` using [ArmeriaRetrofit#builder(String)](type):
