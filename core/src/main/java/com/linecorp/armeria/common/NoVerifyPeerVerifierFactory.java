...
/**
 * A {@link TlsPeerVerifierFactory} that disables TLS peer verification.
 */
final class NoVerifyPeerVerifierFactory implements TlsPeerVerifierFactory, TlsPeerVerifier {
     ...
     */
    static NoVerifyPeerVerifierFactory of() {
        return INSTANCE;
    }
