...
public class AppendingPublisherTckTest extends PublisherVerification<Object> {

    public AppendingPublisherTckTest() {
    ...
    public Publisher<Object> createPublisher(long elements) {
        ...
        return new AppendingPublisher<>(Flux.fromStream(LongStream.range(0, elements - 1).boxed()),
                                        "Appended");
    }
     ...
     * The {@link AppendingPublisher} however subscribes publisher and signals error after the first request,
    ...
    public Publisher<Object> createFailedPublisher() {
        return new AppendingPublisher<>(Mono.error(new RuntimeException()), "Appended");
    }
