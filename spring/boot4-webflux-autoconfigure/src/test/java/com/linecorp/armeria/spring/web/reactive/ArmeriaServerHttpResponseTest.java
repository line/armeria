...
import static com.linecorp.armeria.spring.web.version.reactive.VersionSpecificTestUtil.toHeaderEntries;
...
class ArmeriaServerHttpResponseTest {
    ...
    void returnHeadersOnly() throws Exception {
        ...
        for (Entry<String, List<String>> header : toHeaderEntries(response.getHeaders())) {
