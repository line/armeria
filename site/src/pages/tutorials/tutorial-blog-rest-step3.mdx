...
You need the BlogPost.java file, created from [step 2](/tutorials/tutorial-blog-rest-step2). You can always [download](https://github.com/line/armeria-examples/blob/master/rest-api-annotated-service/src/main/java/example/armeria/server/blog/BlogPost.java) the full version of this file, instead of creating one yourself.

## 0. Create a service file

Create a service file, BlogService.java. Import required files as you go along the tutorial or copy at once from the [sample file](https://github.com/line/armeria-examples/blob/master/rest-api-annotated-service/src/main/java/example/armeria/server/blog/BlogService.java).
