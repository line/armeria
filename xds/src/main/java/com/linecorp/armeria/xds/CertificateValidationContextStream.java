...
import io.envoyproxy.envoy.extensions.transport_sockets.tls.v3.CertificateValidationContext.Builder;

final class CertificateValidationContextStream extends RefCountedStream<CertificateValidationContextSnapshot> {

    private final Builder baseContextBuilder;
    @Nullable
    ...
    CertificateValidationContextStream(SubscriptionContext context,
        ...
        this(context, secretSnapshot, CertificateValidationContext.getDefaultInstance());
    }
    ...
    CertificateValidationContextStream(SubscriptionContext context,
        ...
        xdsResource = secretSnapshot.xdsResource();
        baseContextBuilder = baseContext.toBuilder();
    }
    ...
    protected Subscription onStart(SnapshotWatcher<CertificateValidationContextSnapshot> watcher) {
        final CertificateValidationContext validationContext =
                baseContextBuilder.mergeFrom(xdsResource.resource().getValidationContext()).build();
