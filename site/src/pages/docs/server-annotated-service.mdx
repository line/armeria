...
In order to use the blocking task executor, you need to specify the <type://Blocking> annotation:
...
Or, you can use the executor returned by <type://ServiceRequestContext#blockingTaskExecutor()>:
