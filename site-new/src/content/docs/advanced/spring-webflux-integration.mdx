...
For a user who wants to customize the web server, [ArmeriaServerConfigurator](type) is provided.
...
client settings for the Armeria HTTP client, simply define an [ArmeriaClientConfigurator](type) bean
