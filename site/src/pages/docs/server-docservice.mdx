...
### For annotated service
  ...
  @Description("""
      ## A service that provides user information.
  """)
  ...
  - Support enums `description` in annotated service.
  - Support return types documentation in annotated service using <type://@ResponseObject> annotation.
  - Support markdown ([GitHub Flavored Markdown Spec](https://github.github.com/gfm/))
