...
1. [Creating a server](/tutorials/tutorial-blog-rest-create-server)
2. [Preparing a data object](/tutorials/tutorial-blog-rest-prepare-data-object)
3. [Adding services to server](/tutorials/tutorial-blog-rest-add-services-to-server)
4. [Implementing CREATE operation](/tutorials/tutorial-blog-rest-create)
5. [Implementing READ operation](/tutorials/tutorial-blog-rest-read)
6. [Implementing UPDATE operation](/tutorials/tutorial-blog-rest-update)
7. [Implementing DELETE operation](/tutorials/tutorial-blog-rest-delete)
