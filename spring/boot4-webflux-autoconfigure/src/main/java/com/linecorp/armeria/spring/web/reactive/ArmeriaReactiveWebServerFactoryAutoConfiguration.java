...
import com.linecorp.armeria.spring.web.reactive.VersionSpecificConfiguration.WebServerConfiguration;
...
@Import({DataBufferFactoryWrapperConfiguration.class, WebServerConfiguration.class})
